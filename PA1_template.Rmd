...
```
1. The Mean Value of Steps Per Day is **`r steps_mean`**
2. The Median Value of Steps Per Day is **`r steps_median`**
...
```
The maximum no. of steps for 5 minute interval is **`r max_interval$interval`** which is **`r max_interval$steps`**
...
```
The Total no of missing values in the Dataset is **`r missing_values`**
...
```
1. The Mean Value of the Steps per Day for Imputed Data is **`r imputed_steps_mean`**
2. The Median Value of the Steps per Day for Imputed Data is **`r imputed_steps_median`**

##What is the impact of imputing missing data on the estimates of the total daily number of steps?

- The Difference in the Mean Value of Imputed and Non Imputed Data is **`r as.numeric(imputed_steps_mean) - as.numeric(steps_mean)`**
- The Difference in the Median Value of Imputed and Non Imputed Data is **`r as.numeric(imputed_steps_median) - as.numeric(steps_median)`**
